<x-layout :styles="$styles" :title="$title">
    ...
    <div class="wrapper">
        <div class="form">
            ...
            <form action="{{route(trans('routes.productSave.name'))}}" method="post" enctype="multipart/form-data">
                @csrf
        ...
        <div class="form">
            ...
            <form action="{{route(trans('routes.categorySave.name'))}}"method="post">
                @csrf
        ...
        <div class="form">
            ...
            <form action="{{route(trans('routes.subcategorySave.name'))}}" method="post">
                @csrf
